...
#let theorem-box(body, counter-level: none, colors: (:), styles: (:)) = {
  ...
  show: it => styles.at("colorful").fold(it, (it, kind) => {
    show: set-box-frame(
      ...
      title-color: colors.at(kind, default: white).lighten(70%),
      body-color: colors.at(kind, default: white).lighten(70%),
      thickness: 1pt,
      radius: 0pt,
